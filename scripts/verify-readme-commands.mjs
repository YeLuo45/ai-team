...
record('test targeted server', run('npm', ['test', '--', 'packages/ai-team-server/test/team-orchestration-routes.test.ts']), /77 passed/);
record('test targeted web console', run('npm', ['test', '--', 'packages/ai-team-web/test/team-orchestration-console.test.tsx']), /8 passed/);
...
record('test targeted delivery summary', run('npm', ['test', '--', 'packages/ai-team-core/test/delivery-summary-v51.test.ts']), /50 passed/);
record('test targeted delivery cli', run('npm', ['test', '--', 'packages/ai-team-cli/test/delivery-command.test.ts']), /7 passed/);
