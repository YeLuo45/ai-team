...
export const AGENT_KINDS: AgentKind[] = [
  'interview', 'training', 'one-on-one', 'review', 'resume', 'insights', 'score', 'search', 'legal', 'tech-policy', 'media-compliance', 'sibling-org-conflict', 'pipeline', 'unknown',
];
...
function emptyByKind(): Record<AgentKind, number> {
  return {
    ...
    insights: 0, score: 0, search: 0, legal: 0, 'tech-policy': 0, 'media-compliance': 0, 'sibling-org-conflict': 0, pipeline: 0, unknown: 0,
  };
}
